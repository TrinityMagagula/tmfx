...
const auth = getAuth(app);
  ...
  window.withdrawal = async function () {
    const withdrawalAmount = getFloat('withdraw-zar');
    if (withdrawalAmount > -50) {
      alert("Minimum withdrawal is R50");
      return;
    }
    ...
    const newTransaction = {
      ...
      Date: new Date().toISOString(), // timestamp with timezone
      Quantity: 1,
      Status: "Incomplete",
      Type: "Withdrawal",
      ItemName: "Credits"
