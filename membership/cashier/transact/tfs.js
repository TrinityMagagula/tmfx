...
const supabase = getSupabaseClient();
        ...
        async function getMentorshipPrice() {
            try {
                ...
                if (data && data['TFS']) {
                    mentorshipPrice = data['TFS'];
                    document.getElementById('subscriptionText9').textContent = 
        ...
        async function TFS() {
            ...
            try {
                ...
                const popup = document.getElementById('mentorshipPopup9');
        ...
        function showAlreadySubscribedPopup() {
            const popup = document.getElementById('alreadySubscribedPopup9');
            popup.classList.add('active');
        }
        ...
        async function handleSubscription() {
            // Get elements
            const confirmBtn = document.getElementById('confirmBtn9');
            const loadingSpinner = document.getElementById('loadingSpinner9');
            const subscriptionText = document.getElementById('subscriptionText9');
            const doneMessage = document.getElementById('doneMessage9');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmBtn9').addEventListener('click', handleSubscription);
            
            // Close button click (subscription popup)
            document.getElementById('closeBtn9').addEventListener('click', () => hidePopup('mentorshipPopup9'));
            
            // Close button click (already subscribed popup)
            document.getElementById('alertCloseBtn9').addEventListener('click', () => hidePopup('alreadySubscribedPopup9'));
        });
