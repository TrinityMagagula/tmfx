...
const supabase = getSupabaseClient();
        ...
        async function getMentorshipPrice() {
            try {
                ...
                if (data && data['Tournament']) {
                    ...
                    document.getElementById('subscriptionTextpk').textContent = 
        ...
        async function pk() {
            ...
            try {
                ...
                const popup = document.getElementById('mentorshipPopuppk');
        ...
        function showAlreadySubscribedPopup() {
            const popup = document.getElementById('alreadySubscribedPopuppk');
            popup.classList.add('active');
        }
        ...
        async function handleSubscription() {
            // Get elements
            const confirmBtn = document.getElementById('confirmBtnpk');
            const loadingSpinner = document.getElementById('loadingSpinnerpk');
            const subscriptionText = document.getElementById('subscriptionTextpk');
            const doneMessage = document.getElementById('doneMessagepk');
            const closeBtn = document.getElementById('closeBtnpk');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmBtnpk').addEventListener('click', handleSubscription);
            
            // Close button click (subscription popup)
            document.getElementById('closeBtnpk').addEventListener('click', () => hidePopup('mentorshipPopuppk'));
            
            // Close button click (already subscribed popup)
            document.getElementById('alertCloseBtnpk').addEventListener('click', () => hidePopup('alreadySubscribedPopuppk'));
        });
