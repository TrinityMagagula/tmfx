...
const supabase = getSupabaseClient();
        ...
        // Function to get DTU Yearly price from ItemList table
        async function getMentorshipPrice() {
            try {
                ...
                if (data && data['DTU']) {
                    mentorshipPrice = data['DTU'];
                    document.getElementById('subscriptionTexts').textContent = 
                        `Top Up Demo Account For R${mentorshipPrice}`;
                }
            } catch (error) {
                console.error('Error fetching Top Up price:', error);
            }
        }
        ...
        async function DTU() {
            ...
            try {
                ...
                const popup = document.getElementById('mentorshipPopups');
        ...
        function showAlreadySubscribedPopup() {
            const popup = document.getElementById('alreadySubscribedPopups');
            popup.classList.add('active');
        }
        ...
        async function handleSubscription() {
            // Get elements
            const confirmBtn = document.getElementById('confirmBtns');
            const loadingSpinner = document.getElementById('loadingSpinners');
            const subscriptionText = document.getElementById('subscriptionTexts');
            const doneMessage = document.getElementById('doneMessages');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmBtns').addEventListener('click', handleSubscription);
            
            // Close button click (subscription popup)
            document.getElementById('closeBtns').addEventListener('click', () => hidePopup('mentorshipPopups'));
            
            // Close button click (already subscribed popup)
            document.getElementById('alertCloseBtns').addEventListener('click', () => hidePopup('alreadySubscribedPopups'));
        });
