...
const supabase = getSupabaseClient();
        ...
        async function getMentorshipPrice() {
            try {
                ...
                if (data && data['Tournament']) {
                    ...
                    document.getElementById('subscriptionTextnf').textContent = 
        ...
        async function nf() {
            ...
            try {
                ...
                const popup = document.getElementById('mentorshipPopupnf');
        ...
        function showAlreadySubscribedPopup() {
            const popup = document.getElementById('alreadySubscribedPopupnf');
            popup.classList.add('active');
        }
        ...
        async function handleSubscription() {
            // Get elements
            const confirmBtn = document.getElementById('confirmBtnnf');
            const loadingSpinner = document.getElementById('loadingSpinnernf');
            const subscriptionText = document.getElementById('subscriptionTextnf');
            const doneMessage = document.getElementById('doneMessagenf');
            const closeBtn = document.getElementById('closeBtnnf');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmBtnnf').addEventListener('click', handleSubscription);
            
            // Close button click (subscription popup)
            document.getElementById('closeBtnnf').addEventListener('click', () => hidePopup('mentorshipPopupnf'));
            
            // Close button click (already subscribed popup)
            document.getElementById('alertCloseBtnnf').addEventListener('click', () => hidePopup('alreadySubscribedPopupnf'));
        });
