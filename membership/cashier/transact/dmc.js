...
const supabase = getSupabaseClient();
        ...
        // Function to get TFS Yearly price from ItemList table
        async function getMentorshipPrice() {
            try {
                ...
                if (data && data['DMC']) {
                    mentorshipPrice = data['DMC'];
                    document.getElementById('subscriptionTexta').textContent = 
                        `Enter Demo Competition For R${mentorshipPrice}`;
                }
            } catch (error) {
        ...
        async function DMC() {
            ...
            try {
                ...
                const popup = document.getElementById('mentorshipPopupa');
        ...
        function showAlreadySubscribedPopup() {
            const popup = document.getElementById('alreadySubscribedPopupa');
            popup.classList.add('active');
        }
        ...
        async function handleSubscription() {
            // Get elements
            const confirmBtn = document.getElementById('confirmBtna');
            const loadingSpinner = document.getElementById('loadingSpinnera');
            const subscriptionText = document.getElementById('subscriptionTexta');
            const doneMessage = document.getElementById('doneMessagea');
            const closeBtn = document.getElementById('closeBtna');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmBtna').addEventListener('click', handleSubscription);
            
            // Close button click (subscription popup)
            document.getElementById('closeBtna').addEventListener('click', () => hidePopup('mentorshipPopupa'));
            
            // Close button click (already subscribed popup)
            document.getElementById('alertCloseBtna').addEventListener('click', () => hidePopup('alreadySubscribedPopupa'));
        });
