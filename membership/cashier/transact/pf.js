...
const supabase = getSupabaseClient();
        ...
        async function getMentorshipPrice() {
            try {
                ...
                if (data && data['Tournament']) {
                    ...
                    document.getElementById('subscriptionTextpf').textContent = 
        ...
        async function pf() {
            ...
            try {
                ...
                const popup = document.getElementById('mentorshipPopuppf');
        ...
        function showAlreadySubscribedPopup() {
            const popup = document.getElementById('alreadySubscribedPopuppf');
            popup.classList.add('active');
        }
        ...
        async function handleSubscription() {
            // Get elements
            const confirmBtn = document.getElementById('confirmBtnpf');
            const loadingSpinner = document.getElementById('loadingSpinnerpf');
            const subscriptionText = document.getElementById('subscriptionTextpf');
            const doneMessage = document.getElementById('doneMessagepf');
            const closeBtn = document.getElementById('closeBtnpf');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmBtnpf').addEventListener('click', handleSubscription);
            
            // Close button click (subscription popup)
            document.getElementById('closeBtnpf').addEventListener('click', () => hidePopup('mentorshipPopuppf'));
            
            // Close button click (already subscribed popup)
            document.getElementById('alertCloseBtnpf').addEventListener('click', () => hidePopup('alreadySubscribedPopuppf'));
        });
