  ...
  function calculateAndUpdate() {
    ...
    const withdrawalZar = - amount;

    const balanceEl = document.getElementById('user-balance');
    const withdrawalZarEl = document.getElementById('withdraw-zar');

    if (balanceEl) balanceEl.textContent = balance.toFixed(2);
    if (withdrawalZarEl) withdrawalZarEl.textContent = withdrawalZar.toFixed(2);
  }
